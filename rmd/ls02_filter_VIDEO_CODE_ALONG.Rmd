...
```{r}
yao %>% filter(sex == "Male") # Filter for sex equal to "Male"
```
...
```{r, eval = F, echo = FALSE}
Q_female_nrow <- yao %>% filter(sex == "Female") %>% nrow()
Q_female_nrow
```
...
```{r, eval = F, echo = FALSE}
Q_tsinga_messa <- yao %>% filter(neighborhood %in% c("Tsinga", "Messa"))
Q_tsinga_messa
```
...
```{r, eval = F, echo = FALSE}
Q_male_positive <- yao %>% filter(sex == "Male" & igg_result == "Positive")
Q_male_positive
```
...
```{r, eval = F, echo = FALSE}
Q_not_tsinga_messa <- yao %>% filter(!(neighborhood %in% c("Tsinga", "Messa")))
Q_not_tsinga_messa
```
